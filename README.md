...
For a runnable synthetic predicate, see [the demo predicate](examples/deliberately_faulty_predicate.py).
...
The source archive includes the example predicate, benchmark script and results,
and the workflow illustration. Inspect any real-world failure sample for sensitive
stream content before sharing it. SSE Shrink is licensed under the [MIT License](LICENSE).
